            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="m-0"> @lang('contents.customer') @lang('contents.due_management')</h5>
                        <div role="group" aria-label="Action area">
                            <button class="btn btn-info" type="button" data-toggle="collapse"
                                    data-target="#search-form">
                                <i class="fa fa-search"></i>
                            </button>
                            <a href="{{ route('customerDueManage.create') }}" class="btn btn-primary" title="">
                        ...
                        <table class="table table-sm table-hover">
                            ...
                            @forelse($manage_dues as $due)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('customerDueManage.show', $due->id) }}"
                                           class="btn btn-sm btn-primary" title="Update Due.">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </a>

                                        <a href="{{ route('customerDueManage.edit', $due->id) }}"
                                           class="btn btn-sm btn-primary" title="Update Due.">
                                            <i class="fa fa-pencil" aria-hidden="true"></i>
                                        </a>
                                        <a href="{{ route('customerDueManage.destroy', $due->id) }}"
                                        ...
                                        <form id="delete-form-{{ $due->id }}" action="{{ route('customerDueManage.destroy', $due->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6"
                                        class="text-center">@lang('contents.no_customer_due_manage_available')</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
