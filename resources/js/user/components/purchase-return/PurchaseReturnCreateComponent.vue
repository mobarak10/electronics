                    ...
                    <form action="" @submit.prevent="saleReturn">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-2">
                                <input
                                    ...
                                    v-model="form.date"
                                />
                                <div class="invalid-feedback" v-if="errors && errors.date" v-text="errors.date[0]"/>
                            </div>
                            ...
                            <div class="col-md-4">
                                <v-select
                                    :options="customers"
                                    v-model="customerId"
                                    :class="{'is-invalid': errors && errors.party_id}"
                                ...
                                <div class="invalid-feedback" v-if="errors && errors.party_id" v-text="errors.party_id[0]"/>
                            </div>
                            ...
                            <div class="col-md-3">
                                <select
                                    ...
                                    class="form-control form-control-sm"
                                    :class="{'is-invalid': errors && errors.warehouse_id}"
                                ...
                                <div class="invalid-feedback" v-if="errors && errors.warehouse_id" v-text="errors.warehouse_id[0]"/>
                            </div>
                        ...
                        <div class="row">
                            <div class="my-2 col-12 border-top border-bottom">
                                ...
                                <div class="text-sm text-danger" v-if="errors && errors.products" v-text="errors.products[0]"/>
                            </div>
                        </div>
                        <!-- Table Form End -->
...
export default {
    name: "PurchaseReturnCreateComponent",
    props: {
        warehouses: Array,
        cashes: Array,
        customers: Array,
        ...
        saleReturn() {
            ...
            this.selectedProducts.forEach(product => {
                ...
                form.products.push({
                    ...
                    return_price: product.purchase_price,
            ...
            this.$awn.asyncBlock(
                axios.post(baseURL + "user/purchase-return", form),
                response => {
                    // redirect to invoice
                ...
                reason => {
                    ...
                    if (reason && reason.response && reason.response.status == 422){
