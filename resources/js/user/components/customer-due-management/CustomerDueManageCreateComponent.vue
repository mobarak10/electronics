<template>
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="m-0">{{lang.customer}} {{lang.due_manage}} </h5>
            ...
            <form method="post" @submit.prevent="save" class="row">
                ...
                <div class="col-md-12" v-if="customerBalance">
                    <p class="d-block bg-dark text-light p-1 px-2">
                        ৳ {{ Math.abs(customerBalance) }} {{ customerBalance > 0 ? 'Receivable' : 'Payable' }}
                    </p>
                </div>
                ...
                <div v-if="where === 'bank'" class="col-md-12 pt-3">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 required">
                            <label for="bank-account">{{lang.bank}} {{lang.account}}</label>
...
export default {
    ...
    props: ['customers', 'banks', 'cashes', 'brands', 'lang'],
    computed: {
        listURL(){
